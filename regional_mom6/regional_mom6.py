...
class experiment:
    ...
    def vgrid(self):
        ...
        Note: each access rewrites ``vgrid.nc`` in ``mom_input_dir`` via
        ``VGrid.write_z_file``.
        """
        ...
        return self.m6f_vgrid.write_z_file(self.mom_input_dir / "vgrid.nc")
    ...
    def _make_vgrid(self, thicknesses=None):
        ...
        ds = self.m6f_vgrid.write_z_file(self.mom_input_dir / "vgrid.nc")
