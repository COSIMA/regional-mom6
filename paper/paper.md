...
Regional modelling further allows for the "downscaling" of coarse-resolution global ocean or climate models, permitting this ways the representation of the variation in local conditions that might otherwise be contained only within a few (or even a single!) model grid cells in a global model.
