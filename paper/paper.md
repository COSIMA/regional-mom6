...
A snapshot of surface speed in MOM6 simulation in the Tasman sea. The source code can be found at . \label{fig:example}
\end{figure}
...
<!-- https://github.com/ashjbarnes/tasman-tides -->
